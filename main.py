...
def print_and_save_analysis(ip_counts, endpoint_counts, failed_logins):
    csv_output = []
...
def main():
    """Main function to read log file and perform analysis."""
    with open('sample.log', 'r') as log_file:
        log_entries = log_file.readlines()
    ip_counts, endpoint_counts, failed_logins = analyze_log_entries(log_entries)
    print_and_save_analysis(ip_counts, endpoint_counts, failed_logins)
